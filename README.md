...
Для запуска или сборки проекта вам потребуется компьютер под управлением Windows и установленный Python (рекомендуется Python 3.8+).

> ###### ⚠ Желательно использовать Windows 10, для корректного отображения UI в Windows 11 требуется включить режим совместимости с Windows 8

...
*   **Глубокий анализ:** Сканирование всех папок и файлов выбранного пути, включая учет размеров на уровне директорий.
...
*   **Автоклассификация:** Автоматическая классификация файлов по типу (видео, фото, документы) на основе расширения.
*   **Экспорт данных:** Возможность экспорта результатов сканирования в формате CSV.
*   **Системный трей:** Работа в фоновом режиме через значок в системном трее Windows/Linux.
